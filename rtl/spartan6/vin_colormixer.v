...
module vin_colormixer(
    ...
    // is_colored if source saturation is at or above roughly 10/255.
    // Input RGB is 6-bit, so 10/255 maps to about 2.5/63.
    ...
    wire is_colored_odd = (sat_odd > 6'd2);
    ...
    wire is_colored_even = (sat_even > 6'd2);
