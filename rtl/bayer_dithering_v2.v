...
//
// 2 cycle latency (1 for edge detection, 1 for output)
`timescale 1ns / 1ps
`default_nettype none

module bayer_dithering_v2 #(
    parameter COLORMODE = "RGBW",
    parameter LINE_WIDTH = 1100  // Max pixels per line (for line buffer)
) (
    input wire        clk,
    input wire        rst,
    input wire [31:0] vin,
